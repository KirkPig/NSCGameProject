...
{
    public partial class frmDeliveryPrint : MetroFramework.Controls.MetroUserControl
    {

        int dpi = 96;
        float mmpi = 25.4f;
        SqlConnection conn = Connection.getConnection();
        public frmDeliveryPrint()
        {
            InitializeComponent();
        }

        private void FrmDeliveryPrint_Load(object sender, EventArgs e)
        {
        ...
        private void PrintDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (currentPage == 1)
            {
                printDoc.printDelivery(metroTextBox2.Text, metroDateTime1.Text, metroTextBox3.Text, metroTextBox4.Text, metroTextBox5.Text,
        ...
        private void MetroTextBox1_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlDataAdapter sda = new SqlDataAdapter("select * from tblDeliveryReport where Id like '" + str + "%'", conn);
                ...
                if (dt.Rows.Count == 1)
                {
                    ...
                    sda = new SqlDataAdapter("select * from tblDelivery where Id like '" + str + "%'", conn);
