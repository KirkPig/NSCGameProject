...
{
    public partial class frmDelivery : MetroFramework.Controls.MetroUserControl
    {
        public frmDelivery()
        {
            InitializeComponent();
        ...
        void show()
        {
            try
            {
                ...
                SqlDataAdapter sda = new SqlDataAdapter("select * from tblDeliveryReport", conn);
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    SqlDataAdapter sda1 = new SqlDataAdapter("select * from tblDelivery where Id = N'" + id + "'", conn);
        ...
        private void MetroButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String str = "select * from tblDeliveryReport where (Date like '%" + Month + "%' AND Customer like N'%" + CustomerName + "%')";
        ...
        private void PrintDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            try
            {
                ...
                String str = "select * from tblDeliveryReport where (Date like '%" + Month + "%' AND Customer like N'%" + CustomerName + "%') order by Date";
                SqlDataAdapter sda = new SqlDataAdapter(str, conn);
                ...
                e.Graphics.DrawString("สรุปใบส่งสินค้าประจำเดือน " + Month, new Font(font, 14, FontStyle.Bold), Brushes.Black, rect, strformat);
