...
{
    public partial class frmCreditNote : MetroFramework.Controls.MetroUserControl
    {
        ...
        private void FrmCreditNote_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlDataAdapter sda = new SqlDataAdapter("select * from tblCreditNoteReport", conn);
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    SqlDataAdapter sda1 = new SqlDataAdapter("select * from tblCreditNote where Id = N'" + id + "'", conn);
        ...
        private void MetroButton1_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                String str = "select * from tblCreditNoteReport where (Date like '%" + Month + "%' AND Customer like N'%" + CustomerName + "%')";
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    metroGrid1.Rows[n].Cells[3].Value = dr[14].ToString();
                }
        ...
        private void PrintDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            try
            {
                ...
                String str = "select * from tblCreditNoteReport where (Date like '%" + Month + "%' AND Customer like N'%" + CustomerName + "%') order by Date";
                SqlDataAdapter sda = new SqlDataAdapter(str, conn);
