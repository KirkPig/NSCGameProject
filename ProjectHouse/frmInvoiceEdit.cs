...
{
    public partial class frmInvoiceEdit : MetroFramework.Controls.MetroUserControl
    {
        ...
        private void MetroButton3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String qry = "delete from tblInvoiceReport where Id = N'" + temp + "' ";
                SqlCommand sql = new SqlCommand(qry, conn);
                sql.ExecuteNonQuery();

                qry = "delete from tblInvoice where Id = N'" + temp + "' ";
            ...
            try
            {
                ...
                if (dt.Rows.Count == 1)
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        ...
                        metroGrid1.Rows[n].Cells[6].Value = 0;
                        metroGrid1.Rows[n].Cells[7].Value = String.Format("{0:0,0.00}", float.Parse(dr[6].ToString()));
                    }
