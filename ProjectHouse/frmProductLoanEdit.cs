...
{
    public partial class frmProductLoanEdit : MetroFramework.Controls.MetroUserControl
    {
        ...
        public frmProductLoanEdit()
        {
            InitializeComponent();
        }

        private void FrmProductLoanEdit_Load(object sender, EventArgs e)
        {
            reset();
        ...
        private void MetroButton3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String qry = "delete from tblProductLoanReport where Id = N'" + temp + "' ";
                SqlCommand sql = new SqlCommand(qry, conn);
                sql.ExecuteNonQuery();

                qry = "delete from tblProductLoan where Id = N'" + temp + "' ";
