...
{
    public partial class frmProductLoanNew : MetroFramework.Controls.MetroUserControl
    {
        ...
        private string generateId(DateTime time)
        {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    gid = String.Format("BL{0:yy}0{0:MM}{1:000}", time, k);
                    String str = "select * from tblProductLoanReport where Id like N'" + gid + "'";
        ...
        private void FrmProductLoanNew_Load(object sender, EventArgs e)
        {
        ...
        private void MetroButton3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String str = "insert into tblProductLoanReport values(N'" + ID + "',N'" + date + "',N'" + customerName + "',N'" + customerTaxID + "',N'" + customerAddress + "',N'" + customerTel + "'" +
                ...
                for (int i = 0; i < metroGrid1.Rows.Count; i++)
                {
                    ...
                    str = "insert into tblProductLoan values(N'" + ID + "'," + no + ",N'" + desc + "'," + quan + ",N'" + unit + "'," + price + "," + discount + "," + amount + ")";
                ...
                String qr = "update tblGenerateID set NumYear = " + metroDateTime1.Value.Year +
                    ", NumMonth = " + metroDateTime1.Value.Month + ", NumBill = " + bill + " where Name = 'BL'";
        ...
        private void PrintDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            printDoc.printProductLoan(metroTextBox1.Text, metroDateTime1.Text, metroTextBox3.Text, metroTextBox4.Text, metroTextBox5.Text,
