...
{
    public partial class frmOrderNew : MetroFramework.Controls.MetroUserControl
    {
        ...
        private string generateId(DateTime time)
        {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    gid = String.Format("PO{0:yy}0{0:MM}{1:000}", time, k);
                    String str = "select * from tblOrdersReport where Id like N'" + gid + "'";
        ...
        private void MetroButton3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String qr = "update tblGenerateID set NumYear = " + metroDateTime1.Value.Year +
                    ", NumMonth = " + metroDateTime1.Value.Month + ", NumBill = " + bill + " where Name = 'PO'";
