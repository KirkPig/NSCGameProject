...
{
    public partial class frmDeliveryEdit : MetroFramework.Controls.MetroUserControl
    {
        ...
        private void FrmDeliveryEdit_Load(object sender, EventArgs e)
        {
            reset();
        ...
        private void MetroButton3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String qry = "delete from tblDeliveryReport where Id = N'" + temp + "' ";
                SqlCommand sql = new SqlCommand(qry, conn);
                sql.ExecuteNonQuery();

                qry = "delete from tblDelivery where Id = N'" + temp + "' ";
