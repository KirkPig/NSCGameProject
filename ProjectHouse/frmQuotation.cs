...
{
    public partial class frmQuotation : MetroFramework.Controls.MetroUserControl
    {
        ...
        void show()
        {
            try
            {
                ...
                SqlDataAdapter sda = new SqlDataAdapter("select * from tblQuotationReport", conn);
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    SqlDataAdapter sda1 = new SqlDataAdapter("select * from tblQuotation where Id = N'" + id + "'", conn);
        ...
        private void MetroButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String str = "select * from tblQuotationReport where (Date like '%" + Month + "%' AND Customer like N'%" + CustomerName + "%')";
        ...
        private void PrintDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            try
            {
                ...
                String str = "select * from tblQuotationReport where (Date like '%" + Month + "%' AND Customer like N'%" + CustomerName + "%') order by Date";
                SqlDataAdapter sda = new SqlDataAdapter(str, conn);
