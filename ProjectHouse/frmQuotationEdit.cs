...
{
    public partial class frmQuotationEdit : MetroFramework.Controls.MetroUserControl
    {
        ...
        public frmQuotationEdit()
        {
            InitializeComponent();
        }

        private void FrmQuotationEdit_Load(object sender, EventArgs e)
        {
            reset();
        ...
        private void MetroButton3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //Old Data Delete
                String qry = "delete from tblQuotationReport where Id = N'" + temp + "' ";
                SqlCommand sql = new SqlCommand(qry, conn);
                sql.ExecuteNonQuery();

                qry = "delete from tblQuotation where Id = N'" + temp + "' ";
                ...
                if (chk)
                {
                    MessageBox.Show("Quotation " + ID + " has been edited!");
                }
                else
                {
